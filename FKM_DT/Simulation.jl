...
sc1 = sof(qc1)
sc2 = sof(qc2)
S1 = collect(sc1+0.01:0.01:sc1+0.041)
S2 = collect(sc1+0.06:0.01:sc1+0.091)
S3 = collect(sc1-0.09:0.01:sc1-0.06)
S4 = collect(sc1-0.04:0.01:sc1-0.01)
S5 = collect(sc2+0.01:0.01:sc2+0.041)
S6 = collect(sc2+0.06:0.01:sc2+0.091)
S7 = collect(sc2-0.09:0.01:sc2-0.059)
S8 = collect(sc2-0.04:0.01:sc2-0.009)
S = sort(vcat(S1,S2,S3,S4,S5,S6,S7,S8))
Q = qof.(S)
